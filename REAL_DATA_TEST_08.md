...
Contents API, content extraction, or `outputSchema`. The adapter asks Exa only
for raw company-category search results. JYRA remains responsible for canonicalization, entity
