    ...
    <div className="h-full min-h-[80vh] flex flex-col items-center justify-center max-w-2xl mx-auto text-center space-y-6 animate-in fade-in zoom-in-95 duration-500">
      ...
      <div className="space-y-2">
        ...
        <p className="text-lg text-muted-foreground">
          Reserved for the Market Universe Phase.
        </p>
      </div>
      
      <p className="text-sm text-muted-foreground leading-relaxed max-w-lg">
        Soon you will be able to qualify accounts, map stakeholders, and evaluate market fitness directly in this workspace. No synthetic data will be shown until external providers are configured.
      </p>
